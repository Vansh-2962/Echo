...
// @ts-nocheck 
/*
 * This file exports the `BodyField` model and its related types.
 *
...
export type GetBodyFieldAggregateType<T extends BodyFieldAggregateArgs> = {
      [P in keyof T & keyof AggregateBodyField]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateBodyField[P]>
    : Prisma.GetScalarType<T[P], AggregateBodyField[P]>
}
...
type GetBodyFieldGroupByPayload<T extends BodyFieldGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<BodyFieldGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof BodyFieldGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], BodyFieldGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], BodyFieldGroupByOutputType[P]>
      }
    >
  >
...
export type BodyFieldCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<BodyFieldFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface BodyFieldDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['BodyField'], meta: { name: 'BodyField' } }
  /**
   ...
   * })
  **/
  count<T extends BodyFieldCountArgs>(
    args?: Prisma.Subset<T, BodyFieldCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], BodyFieldCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends BodyFieldGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, BodyFieldGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetBodyFieldGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
