...
import { createRequest, createCollection, getAllCollections, saveRequest, deleteRequest, deleteCollection, renameRequest, getHistory, deleteHistory, } from "../controller/proxy.controller.js";
import { isAuth } from "../middlewares/auth.js";
import { getPlan } from "../controller/plan.controller.js";
const router = express.Router();
router.route("/plan").get(isAuth, getPlan);
