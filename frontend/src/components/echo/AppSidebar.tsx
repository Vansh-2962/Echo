...
export const AppSidebar = () => {
  ...
  const { sidebarOpen, sidebarTab, setSidebarTab, loadRequest } =
    useRequestStore();
  ...
  const handleNewCollSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    if (!plan || plan.name !== "FREE") return;

    if (getAllCollections.data?.length >= plan.collections) {
                          ...
                          <AlertDialogContent>
                            <AlertDialogHeader>
                              ...
                              <AlertDialogDescription>
                                ...
                                permanently delete {coll.name} collection and
                                all its requests.
                              </AlertDialogDescription>
                            </AlertDialogHeader>
                            <AlertDialogFooter>
